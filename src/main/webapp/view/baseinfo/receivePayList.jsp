      ...
      <div class="card col-md-2">
        <div class="card-header">
          <div class="d-flex align-items-center">
            <a class="btn btn-primary" href="pcIncomeCategory/page/incomeCategoryList" target="_blank">
                  ...
                  <div class="modal-body">
                    <form>
                      <div class="row">
                        ...
                        <div class="col-sm-12">
                          <div class="form-group form-group-default">
                            <label>类别</label> <input id="receivepaytype" type="text" class="form-control"
                              placeholder="类别">
                          </div>
                        </div>
                        <div class="col-sm-12">
                          <div class="form-group form-group-default">
                            <label>名称</label> <input id="name" type="text" class="form-control" placeholder="名称">
                          </div>
                        </div>
                        <div class="col-sm-12">
                          <div class="form-group form-group-default">
                        ...
                        <div class="col-sm-12">
                          <div class="form-group form-group-default">
                            <label>计算提成</label> <input id="iscommission" type="text" class="form-control"
                              placeholder="计算提成">
                          </div>
                        </div>
                      </div>
