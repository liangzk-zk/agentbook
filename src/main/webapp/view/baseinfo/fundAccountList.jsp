...
<script type="text/javascript" src="${contextPath}/resources/js/baseinfo/fundaccount/fundaccountList.js"></script>
</head>
<body>
  <div class="page-inner">
    <div class="page-header">
      <h4 class="page-title">资金账户管理</h4>
      <ul class="breadcrumbs">
        <li class="nav-home"><a href="#"> <i class="flaticon-home"></i>
        </a></li>
        <li class="separator"><i class="flaticon-right-arrow"></i></li>
        <li class="nav-item"><a href="#">资金账户管理</a></li>
        <li class="separator"><i class="flaticon-right-arrow"></i></li>
        <li class="nav-item"><a href="#">资金账户管理</a></li>
      </ul>
    </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
                                ...
                                <input id="id" type="text" style="display: none" class="form-control" placeholder="fill name">
                                    <div class="col-sm-12">
                                        <div class="form-group form-group-default">
                                            ...
                                            <label>资金编码</label>
                                            <input id="fundcode" type="text" class="form-control" placeholder="资金编码">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group form-group-default">
                                            <label>资金名称</label>
                                            <input id="fundname" type="text" class="form-control" placeholder="资金名称">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group form-group-default">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group form-group-default">
                                            <label>期初金额</label>
                                            <input id="intialamount" type="text" class="form-control" placeholder="期初金额">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group form-group-default">
            ...
            <div class="table-responsive">
              <table id="fundaccountList" class="display table table-striped table-hover">
              </table>
            </div>
          </div>
        </div>
