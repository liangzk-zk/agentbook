...
<script type="text/javascript" src="${contextPath}/resources/js/baseinfo/payment/paymentList.js"></script>
<style type="text/css">
.modal-dialog {
    max-width: 80%;
}
...
<body>
  <div class="page-inner">
    <div class="page-header">
      <h4 class="page-title">付款项目管理</h4>
      <ul class="breadcrumbs">
        <li class="nav-home"><a href="#"> <i class="flaticon-home"></i>
        </a></li>
        <li class="separator"><i class="flaticon-right-arrow"></i></li>
        <li class="nav-item"><a href="#">付款项目管理</a></li>
        <li class="separator"><i class="flaticon-right-arrow"></i></li>
        <li class="nav-item"><a href="#">付款项目管理</a></li>
      </ul>
    </div>
      ...
      <div class="card col-md-2">
          <div class="card-header">
              <div class="d-flex align-items-center">
                  <button class="btn btn-round ml-auto" id="addPaymentCategoryInfo" data-toggle="modal"
                          data-target="#addPaymentCategoryInfoModal">
                      <i class="fa fa-plus"></i>分类
                  </button>
              </div>
          </div>
          <div class="card-body">
              <ul class="ztree" id="paymentCategoryTree"></ul>
          </div>
      </div>
      <div class="col-md-10">
        <div class="card">
                                ...
                                <input id="ids" type="text" style="display: none" class="form-control" placeholder="fill name">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                          <em style="color: red;">*</em> <label>所属分类</label> <input id="paytypename" type="text"
                                            class="form-control" placeholder="所属分类"> <input id="paytype" type="hidden"
    ...
    <div class="modal fade" id="addPaymentCategoryInfoModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="height: 800px;">
                ...
                <div class="modal-body">
                    <iframe id="contentSubFrame" src="<%= contextPath%>/pcPaymentCategory/page/paymentCategoryList" width="100%" height="100%" frameborder=0></iframe>
                </div>
                <div class="modal-footer no-bd">
                    <%--<button type="button" id="addButton" class="btn btn-primary">确定</button>--%>
                    <button type="button" class="btn btn-danger" data-dismiss="modal">关闭</button>
