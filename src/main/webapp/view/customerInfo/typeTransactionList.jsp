...
<script type="text/javascript" src="${contextPath}/resources/js/customerInfo/typeTransaction/typeTransactionList.js"></script>
</head>
<body>
  <div class="page-inner">
    <div class="page-header">
      <h4 class="page-title">往来类别管理</h4>
      <ul class="breadcrumbs">
        <li class="nav-home"><a href="#"> <i class="flaticon-home"></i>
        </a></li>
        <li class="separator"><i class="flaticon-right-arrow"></i></li>
        <li class="nav-item"><a href="#">往来类别管理</a></li>
        <li class="separator"><i class="flaticon-right-arrow"></i></li>
        <li class="nav-item"><a href="#">往来类别管理</a></li>
      </ul>
    </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table id="typeTransactionList" class="display table table-striped table-hover">
              </table>
            </div>
          </div>
        </div>
