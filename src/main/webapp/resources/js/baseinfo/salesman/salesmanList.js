$(function() {
              ...
              $('button[cmd="editBtn"]')
                  .click(
                      function(e) {
                        ...
                        var pwd = $('#salesmanList').DataTable().row(rowIndex).data().pwd;
                        var isentersys = $('#salesmanList').DataTable().row(rowIndex).data().isentersys;
                        var entrydate = $('#salesmanList').DataTable().row(rowIndex).data().entrydate;
                        var resigndate = $('#salesmanList').DataTable().row(rowIndex).data().resigndate;
                            ...
                            function() {
                              $('#addRowModal').on(
                                  ...
                                  function(event) {
                                    ...
                                    modal.find('#pwd').val(pwd);
                                    modal.find('#isentersys').val(isentersys);
                                    modal.find('#entrydate').val(entrydate);
                                    modal.find('#resigndate').val(resigndate);
              ...
              $('button[cmd="deleteBtn"]').click(function(e) {
                ...
                swal({
                      ...
                      if (Delete) {
                        $.ajax({
                          type : "DELETE",
                          url : GlobalParam.context + "/rest/baseinfo/salesman/deleteSalesman/"+id,
                          contentType : 'application/json',
                          success : function(ret) {
  ...
  $("#addButton").click(function(e) {
    ...
    $.ajax({
      ...
      contentType : 'application/json',
      success : function(ret) {
        if (ret.code == 110004 || ret.code == 110005) {
          $('#salesmanList').DataTable().draw(true);
