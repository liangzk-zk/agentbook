      ...
      .DataTable(
          {
            columns : [
                {
                  ...
                  render : function(data) {
                    return "<label class=\"mt-checkbox mt-checkbox-outline\"><input type=\"checkbox\" name=\"paymentListChk\" value=\""
            ...
            ajax : function(data, cb, settings) {
              ...
              $.ajax({
                type : "POST",
                url : GlobalParam.context + "/rest/baseinfo/payment/getPaymentList",
