...
public class VerifiedGroup extends Group {
    private static final long serialVersionUID = -6943374783159656262L;
    ...
    public Group add(Criterion criterion) {
        if (criterion instanceof Between) {
            ...
            super.add(new VerifiedBetween(baseType, between.getName(), between.getValue(), between.getValue2()));
