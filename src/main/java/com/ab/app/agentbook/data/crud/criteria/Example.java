...
public final class Example extends Group {
    private static final long serialVersionUID = 6688945434237478960L;
        ...
        if (!"boolean".equals(className)) {
            if (excludeZeroes) {
                ...
                if (number.intValue() != 0) {
                    ...
                    log.debug("Excluding primitive value: " + value + " for property named: " + name + " of class: "
                            + className);
                }
            } else {
                this.eq(name, value);
