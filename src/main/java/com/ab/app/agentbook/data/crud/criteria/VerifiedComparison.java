...
public class VerifiedComparison extends Comparison {
    private static final long serialVersionUID = -5382753945440651L;
    ...
    public VerifiedComparison(final Class<?> baseType, final String aName, final Operator aOperator,
            final Object aValue) {
        ...
        try {
            ...
            if (!found) {
                throw new RuntimeException(
                        "Bad property " + propertyName + " of class " + type + " baseType " + baseType);
            }
            return null;
        } catch (Exception ex) {
