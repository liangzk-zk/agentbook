 ...
 */
@Entity
@Table(name = "ab_income_category_item", schema = "agentbook", catalog = "")
public class AbIncomeCategoryItemEntity {
    /**
     * 主键ID
     */
    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        AbIncomeCategoryItemEntity that = (AbIncomeCategoryItemEntity) o;
