...
public class PaymentCategoryController implements InitializingBean{
    ...
    @ResponseBody
    public Result addFundAccount(@RequestBody PaymentCategoryInfo info) {
        Result result = new Result();
    ...
    @ResponseBody
    public Result updateUser(@RequestBody PaymentCategoryInfo info) {
        Result result = new Result();
        if(info.getId()==null) {
        ...
        PaymentCategoryInfo fundAccount = paymentCategoryService.findById(info.getId());
        if(fundAccount==null) {
            return result.failure(ResultCode.RESULE_DATA_NONE);
        }
        fundAccount = paymentCategoryService.update(fundAccount);
        if(fundAccount==null) {
